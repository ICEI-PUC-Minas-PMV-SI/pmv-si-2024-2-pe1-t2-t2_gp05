...
Funcionamento da aplicação ******** EDITAR ESTA PARTE ADAPTANDO PARA O CONTEXTO DA NOSSA APLICAÇÂO/PROJET***************************
...
2- Login: Página para logar ou cadastrar uma nova conta. Nesse momento o usuário pode escolher qual tipo de conta irá criar de acordo com sua necessidade, podendo ser um Prestador De Serviço ou Cliente (procurar por um prestador de serviço). A página seguinte para o qual o usuário será direcionado dependerá do tipo de conta selecionada.

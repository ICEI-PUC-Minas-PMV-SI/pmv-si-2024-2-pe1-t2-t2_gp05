...
**Para** Garantir que o acesso às funcionalidades seja adequado ao meu tipo de perfil e credenciais. <br>

**Critérios de Aceitação:** 

1.	O formulário de cadastro deve exigir os campos “Nome”, “Email”, “Senha”, “Confirmação Senha” e “Tipo Perfil” (Advogado ou Cliente). 

2.	Todos os campos obrigatórios possuem asterisco na label para orientar o utilizador e caso algum campo obrigatório não seja preenchido, o sistema deve exibir uma mensagem de erro informando o que precisa ser corrigido. 

3.	O sistema deve verificar se a senha e a confirmação de senha coincidem. Caso contrário, uma mensagem de erro deve ser exibida. 

4.	O usuário pode fazer o upload da sua “Foto” durante o cadastro, que será exibida como avatar ao lado do “Nome” do utilizador cadastrado no topbar quando logado na aplicação. 

5.	Após o cadastro com sucesso, o usuário deve ser direcionado para a tela inicial. 

6.	O usuário pode editar suas informações de cadastro posteriormente através de um menu suspenso no topbar, alterando campos como nome, email e senha, e, sem seguida, conseguindo realizar login com as novas credenciais. <br><br>
...
**Como** Advogado ou Cliente, <br>
**Quero** Fazer login com minhas credenciais válidas após o cadastro, <br> 
**Para** Acessar a aplicação e poder visualizar e interagir com as funcionalidades conforme meu tipo de perfil. <br>
...
3.	Após o login bem-sucedido, o avatar e o nome de usuário devem ser exibidos na topbar da aplicação. 

4.	Se as credenciais fornecidas forem inválidas, o sistema deve exibir uma mensagem de erro clara e não permitir o acesso à aplicação. <br><br>
...
1.	O usuário deve poder fazer logout clicando no ícone de expandir no topbar e em seguida, clicando na opção de “ Sair Sessão” do menu suspenso. 
...
2.	O formulário deve estar disponível com campos obrigatórios claramente marcados com asterisco nas suas respectivas labels.
...
3.	Os campos "Número Processo", "Advogado Responsável" e "Data Entrada" não podem ser editados, devendo estar bloqueados para edição.

4.	O sistema deve validar os campos obrigatórios antes de salvar o processo, sendo os campos obrigatórios indicados com asterisco nas suas respectivas labels. Caso algum campo obrigatório não esteja preenchido, uma mensagem de erro deve ser exibida a fim de orientar o utilizador.

5.	Após a atualização com dados válidos, uma mensagem de confirmação deve ser exibida e as alterações devem ser refletidas corretamente na lista de processos. <br><br>
...
**Para** Alterar o status do processo de em andamento para finalizado, indicando a sua conclusão. <br>
...
3.	Após o processo de conclusão, o status do processo na lista deve ser atualizado para "Concluído" e exibido com uma cor distinta, para diferenciá-lo dos processos "Em andamento". <br><br>
...
2.	O processo excluído não deve mais ser exibido na lista de processos.
...
2.	Os ícones exibidos na lista devem conter tooltips que orientem o utilizador sobre suas funcionalidades. <br><br>
...
**Para** Consultar as informações relevantes de forma organizada, com todos os campos bloqueados para edição. <br>
...
3.	Todos os campos do processo devem ser exibidos corretamente, porém devem ser bloqueados para edição. <br><br>
...
**Para** Localizar processos específicos de forma rápida e eficiente, independentemente da coluna da lista. <br>
...
3.	O sistema deve exibir todos os processos automaticamente após a limpeza do filtro.
...
5.	Os ícones exibidos na lista devem conter tooltips que orientem o utilizador sobre suas funcionalidades. <br><br>
...
**Para** Garantir que todas as informações necessárias estejam disponíveis conforme minhas permissões.
...
2.	O ícone para upload deve estar disponível na lista de documentos, sendo que advogado visualiza o ícone de upload tanto da lista de “Documentos Advogado” quanto da lista de “Documentos Requerente” e o cliente visualiza o ícone de upload apenas da lista de “Documentos Requerente”.

3.	Ao clicar no ícone de upload, o sistema redireciona o usuário para outra página onde o documento pode ser selecionado e enviado.

4.	Ao selecionar o arquivo, apenas arquivos com até 2MB são permitidos. Se o arquivo for maior, uma mensagem de erro é exibida e ele não é salvo.

5.	Os campos “Tipo Documento” e “Documento” na página de upload são de caráter obrigatório, apresentando asterisco (*) nas respectivas labels. Se o utilizador tentar salvar com algum destes campos em branco, o sistema deve exibir mensagens de erro, informando a necessidade de preenchimento.
...
3.	Ao clicar no ícone de exclusão, o sistema deve solicitar uma confirmação, exibindo uma mensagem que confirme se ele tem certeza de que deseja excluir o documento.

4.	Se o usuário confirmar a exclusão, o sistema deve exibir uma mensagem de confirmação indicando que o documento foi excluído com sucesso e o documento deve ser removido imediatamente da lista de documentos anexados ao processo.

5.	Se o usuário cancelar a exclusão, o documento deve permanecer na lista e não ser removido. <br><br>

________________________________________
<br>

**US-14. Download de Documentos Carregado**

**Como** Advogado ou Cliente, <br>
**Quero** Realizar download dos documentos incluído, <br>
...
4.	O sistema não deve impor restrições de permissão, permitindo que tanto advogado quanto cliente possam realizar o download de qualquer documento disponível no processo. <br><br>
...
2.	Advogados devem ter acesso a todos os processos do escritório, incluindo aqueles criados por outros advogados, visualizando processos de todos os clientes.

3.	Clientes devem visualizar somente os processos associados a eles, definidos pela correspondência do campo “Nome” inserido no cadastro realizado pelo cliente com o campo "Nome Cliente" do processo adicionado pelo advogado.
...
|------|-----------------------------------------|----| 
| RF01 | Permitir a criação de cadastro da conta, incluindo a escolha do tipo de perfil de acesso (Advogado ou Cliente) | ALTA |  
...
| RF04 | Permitir a visualização da lista de processos pelos perfis de Advogado e Cliente | ALTA |
| RF05 | Permitir a pesquisa na lista de processos com a aplicação de filtros que possibilitem a busca por qualquer conteúdo presente na lista pelos perfis de Advogado e Cliente | MÉDIA |
...
| RF08 | Permitir a edição de dados de um processo existente pelo perfil de Advogado  | ALTA |

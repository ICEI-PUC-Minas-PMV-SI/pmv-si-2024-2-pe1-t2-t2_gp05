...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("update-submit-button-customer").addEventListener("click", function(event) {
        ...
        const newDocument = {
            ...
            createdBy: loggedInUser.name, //processoAtual.lawyer, // Nome do advogado
            file: fileBase64
        };
